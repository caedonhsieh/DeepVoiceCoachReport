...
*The confusion matrices show the relationship between actual phoneme class (horizontal) and predicted phoneme class (vertical) for each coombination of model and type of testing data (mixed or only target). Yellow is a high value; purple is a low value.*
